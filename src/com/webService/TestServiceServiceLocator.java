...
public class TestServiceServiceLocator extends org.apache.axis.client.Service implements com.webService.TestServiceService {
    ...
    private java.lang.String TestService_address = "http://localhost:8080//services/example/TestService";
    ...
    public com.webService.TestService_PortType getTestService() throws javax.xml.rpc.ServiceException {
    ...
    public com.webService.TestService_PortType getTestService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webService.TestServiceSoapBindingStub _stub = new com.webService.TestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webService.TestService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webService.TestServiceSoapBindingStub _stub = new com.webService.TestServiceSoapBindingStub(new java.net.URL(TestService_address), this);
                _stub.setPortName(getTestServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://example", "TestServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://example", "TestService"));
        }
